...
export default function JuguangPage() {
  ...
  // The report query and the page-open refresh are independent requests. A slow
  // refresh must never hide an exact snapshot that the read endpoint already
  // returned, otherwise users see an endless "first sync" loader despite the
  // requested range being available in the database.
